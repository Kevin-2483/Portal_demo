...
namespace Portal
{
  ...
  PortalManager::PortalManager(const HostInterfaces &interfaces)
      : interfaces_(interfaces), next_portal_id_(1), is_initialized_(false), teleport_transition_duration_(0.1f), portal_detection_distance_(0.5f), default_max_recursion_depth_(3)
  {
  }
